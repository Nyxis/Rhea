...
abstract class BaseLog extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'EasyTask\\Bundle\\LogBundle\\Model\\LogPeer';
     ...
     * tags for logs, for easy retrieving
     * @return string
     */
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[] = LogPeer::CODE;
        }
    ...
    public function setTags($v)
    {
        ...
        if ($this->tags !== $v) {
            $this->tags = $v;
            $this->modifiedColumns[] = LogPeer::TAGS;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = LogPeer::DATE;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = LogPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(LogPeer::CODE)) {
            $modifiedColumns[':p' . $index++]  = '`code`';
        }
        if ($this->isColumnModified(LogPeer::MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '`message`';
        }
        if ($this->isColumnModified(LogPeer::TAGS)) {
            $modifiedColumns[':p' . $index++]  = '`tags`';
        }
        if ($this->isColumnModified(LogPeer::DATE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LogPeer::CODE)) $criteria->add(LogPeer::CODE, $this->code);
        if ($this->isColumnModified(LogPeer::MESSAGE)) $criteria->add(LogPeer::MESSAGE, $this->message);
        if ($this->isColumnModified(LogPeer::TAGS)) $criteria->add(LogPeer::TAGS, $this->tags);
        if ($this->isColumnModified(LogPeer::DATE)) $criteria->add(LogPeer::DATE, $this->date);
        return $criteria;
    }
